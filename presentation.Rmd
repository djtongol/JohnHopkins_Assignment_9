...
3. The GitHub repository containing the R codes required to build the Shiny App (**server.R** and **ui.R**)can be accessed [here](https://github.com/djtongol/JohnHopkins_Assignment_9/)
2. The Shiny app can be accessed [here](https://ebid.shinyapps.io/Swiss_Fertility_and_Socioeconomic_Indicators/), which contains
